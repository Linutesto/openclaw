...
This page ties together how OpenPaw handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. OpenPaw keeps a
...
OpenPaw separates the **prompt body** from the **command body**:
...
OpenPaw can expose or hide model reasoning:
