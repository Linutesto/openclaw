...
OpenPaw has two separate “streaming” layers:
...
When block streaming is enabled, OpenPaw can **merge consecutive block chunks**
...
When draft streaming is active, OpenPaw disables block streaming for that reply to avoid double-streaming.
