...
OpenPaw defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, OpenPaw inspects the OS preference (macOS/Windows)
