...
read_when:
  - You are building a OpenPaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openpaw.plugin.json)

Every plugin **must** ship a `openpaw.plugin.json` file in the **plugin root**.
OpenPaw uses this manifest to validate configuration **without executing plugin
