...
You can point OpenPaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenPaw
...
- [Anthropic provider](/providers/anthropic) - Native OpenPaw integration with Claude setup-token or API keys
