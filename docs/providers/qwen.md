---
summary: "Use Qwen OAuth (free tier) in OpenPaw"
read_when:
  - You want to use Qwen with OpenPaw
...
```bash
openpaw models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, OpenPaw will sync credentials
