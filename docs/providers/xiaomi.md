---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenPaw"
read_when:
  - You want Xiaomi MiMo models in OpenPaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenPaw uses
...
```bash
openpaw onboard --auth-choice xiaomi-api-key
# or non-interactive
openpaw onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
