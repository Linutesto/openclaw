...
OpenPaw. All clients (CLI, web UI, macOS app, iOS/Android nodes, headless
...
- If `OPENPAW_GATEWAY_TOKEN` (or `--token`) is set, `connect.params.auth.token`
