...
# Output:
# - dist/OpenPaw.app
# - dist/OpenPaw-<version>.zip
# - dist/OpenPaw-<version>.dmg
...
ZIP="$ROOT_DIR/dist/OpenPaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenPaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenPaw-$VERSION.notary.zip"
