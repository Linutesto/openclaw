...
docker run --rm -t \
  ...
  -e OPENPAW_LIVE_MODELS="${OPENPAW_LIVE_MODELS:-${CLAWDBOT_LIVE_MODELS:-all}}" \
  -e OPENPAW_LIVE_PROVIDERS="${OPENPAW_LIVE_PROVIDERS:-${CLAWDBOT_LIVE_PROVIDERS:-}}" \
  -e OPENPAW_LIVE_MODEL_TIMEOUT_MS="${OPENPAW_LIVE_MODEL_TIMEOUT_MS:-${CLAWDBOT_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e OPENPAW_LIVE_REQUIRE_PROFILE_KEYS="${OPENPAW_LIVE_REQUIRE_PROFILE_KEYS:-${CLAWDBOT_LIVE_REQUIRE_PROFILE_KEYS:-}}" \
