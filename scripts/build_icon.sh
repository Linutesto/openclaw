...
# Defaults target the OpenPaw assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/OpenPaw/Resources/OpenPaw.icns"}
