...
- Version alignment with core OpenPaw release numbers.
...
- First public release of the @openpaw/voice-call plugin.
...
- CLI: `openpaw voicecall` commands (call/start/continue/speak/end/status/tail/expose).
