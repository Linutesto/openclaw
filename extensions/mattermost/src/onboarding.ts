import type { ChannelOnboardingAdapter, OpenClawConfig, WizardPrompter } from "openpaw/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "openpaw/plugin-sdk";
import {
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.openpaw.ai/channels/mattermost",
    ].join("\n"),
