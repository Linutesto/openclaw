...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config")).toContain("openpaw.json");
  });
});
...
describe("normalizeBasePath", () => {
  ...
  it("handles nested paths", () => {
    expect(normalizeBasePath("/apps/openpaw")).toBe("/apps/openpaw");
  });
});
...
describe("pathForTab", () => {
  ...
  it("prepends base path", () => {
    ...
    expect(pathForTab("sessions", "/apps/openpaw")).toBe("/apps/openpaw/sessions");
  });
});
...
describe("tabFromPath", () => {
  ...
  it("handles base paths", () => {
    ...
    expect(tabFromPath("/apps/openpaw/sessions", "/apps/openpaw")).toBe("sessions");
  });
...
describe("inferBasePathFromPathname", () => {
  ...
  it("infers base path from nested paths", () => {
    ...
    expect(inferBasePathFromPathname("/apps/openpaw/sessions")).toBe("/apps/openpaw");
  });
