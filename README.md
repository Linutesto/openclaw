...
<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/openpaw/openpaw/main/docs/assets/openpaw-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/openpaw/openpaw/main/docs/assets/openpaw-logo-text.png" alt="OpenPaw" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/openpaw/openpaw/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/openpaw/openpaw/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/openpaw/openpaw/releases"><img src="https://img.shields.io/github/v/release/openpaw/openpaw?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**OpenPaw** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://openpaw.ai) · [Docs](https://docs.openpaw.ai) · [DeepWiki](https://deepwiki.com/openpaw/openpaw) · [Getting Started](https://docs.openpaw.ai/start/getting-started) · [Updating](https://docs.openpaw.ai/install/updating) · [Showcase](https://docs.openpaw.ai/start/showcase) · [FAQ](https://docs.openpaw.ai/start/faq) · [Wizard](https://docs.openpaw.ai/start/wizard) · [Nix](https://github.com/openpaw/nix-clawdbot) · [Docker](https://docs.openpaw.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`openpaw onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.openpaw.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.openpaw.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.openpaw.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.openpaw.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.openpaw.ai/start/getting-started)

```bash
openpaw onboard --install-daemon

openpaw gateway --port 18789 --verbose

# Send a message
openpaw message send --to +1234567890 --message "Hello from OpenPaw"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
openpaw agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.openpaw.ai/install/updating) (and run `openpaw doctor`).
...
Switch channels (git + npm): `openpaw update --channel stable|beta|dev`.
Details: [Development channels](https://docs.openpaw.ai/install/development-channels).
...
pnpm openpaw onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm openpaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `openpaw` binary.

## Security defaults (DM access)

OpenPaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.openpaw.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `openpaw pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `openpaw doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.openpaw.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.openpaw.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.openpaw.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.openpaw.ai/nodes/voicewake) + [Talk Mode](https://docs.openpaw.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.openpaw.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.openpaw.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.openpaw.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
...
- [Gateway WS control plane](https://docs.openpaw.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.openpaw.ai/web), and [Canvas host](https://docs.openpaw.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.openpaw.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.openpaw.ai/start/wizard), and [doctor](https://docs.openpaw.ai/gateway/doctor).
- [Pi agent runtime](https://docs.openpaw.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.openpaw.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.openpaw.ai/concepts/groups).
- [Media pipeline](https://docs.openpaw.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.openpaw.ai/nodes/audio).

### Channels

- [Channels](https://docs.openpaw.ai/channels): [WhatsApp](https://docs.openpaw.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.openpaw.ai/channels/telegram) (grammY), [Slack](https://docs.openpaw.ai/channels/slack) (Bolt), [Discord](https://docs.openpaw.ai/channels/discord) (discord.js), [Google Chat](https://docs.openpaw.ai/channels/googlechat) (Chat API), [Signal](https://docs.openpaw.ai/channels/signal) (signal-cli), [iMessage](https://docs.openpaw.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.openpaw.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.openpaw.ai/channels/msteams) (extension), [Matrix](https://docs.openpaw.ai/channels/matrix) (extension), [Zalo](https://docs.openpaw.ai/channels/zalo) (extension), [Zalo Personal](https://docs.openpaw.ai/channels/zalouser) (extension), [WebChat](https://docs.openpaw.ai/web/webchat).
- [Group routing](https://docs.openpaw.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.openpaw.ai/channels).

### Apps + nodes

- [macOS app](https://docs.openpaw.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.openpaw.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.openpaw.ai/nodes/talk) overlay, [WebChat](https://docs.openpaw.ai/web/webchat), debug tools, [remote gateway](https://docs.openpaw.ai/gateway/remote) control.
- [iOS node](https://docs.openpaw.ai/platforms/ios): [Canvas](https://docs.openpaw.ai/platforms/mac/canvas), [Voice Wake](https://docs.openpaw.ai/nodes/voicewake), [Talk Mode](https://docs.openpaw.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.openpaw.ai/platforms/android): [Canvas](https://docs.openpaw.ai/platforms/mac/canvas), [Talk Mode](https://docs.openpaw.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.openpaw.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.openpaw.ai/tools/browser): dedicated openpaw Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.openpaw.ai/platforms/mac/canvas): [A2UI](https://docs.openpaw.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.openpaw.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.openpaw.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.openpaw.ai/automation/cron-jobs); [webhooks](https://docs.openpaw.ai/automation/webhook); [Gmail Pub/Sub](https://docs.openpaw.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.openpaw.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.openpaw.ai/concepts/channel-routing), [retry policy](https://docs.openpaw.ai/concepts/retry), and [streaming/chunking](https://docs.openpaw.ai/concepts/streaming).
- [Presence](https://docs.openpaw.ai/concepts/presence), [typing indicators](https://docs.openpaw.ai/concepts/typing-indicators), and [usage tracking](https://docs.openpaw.ai/concepts/usage-tracking).
- [Models](https://docs.openpaw.ai/concepts/models), [model failover](https://docs.openpaw.ai/concepts/model-failover), and [session pruning](https://docs.openpaw.ai/concepts/session-pruning).
- [Security](https://docs.openpaw.ai/gateway/security) and [troubleshooting](https://docs.openpaw.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.openpaw.ai/web) + [WebChat](https://docs.openpaw.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.openpaw.ai/gateway/tailscale) or [SSH tunnels](https://docs.openpaw.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.openpaw.ai/install/nix) for declarative config; [Docker](https://docs.openpaw.ai/install/docker)-based installs.
- [Doctor](https://docs.openpaw.ai/gateway/doctor) migrations, [logging](https://docs.openpaw.ai/logging).
...
- **[Gateway WebSocket network](https://docs.openpaw.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.openpaw.ai/gateway)).
- **[Tailscale exposure](https://docs.openpaw.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.openpaw.ai/gateway/remote)).
- **[Browser control](https://docs.openpaw.ai/tools/browser)** — openpaw‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.openpaw.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.openpaw.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.openpaw.ai/nodes/voicewake) + [Talk Mode](https://docs.openpaw.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.openpaw.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

OpenPaw can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (OpenPaw enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.openpaw.ai/gateway/tailscale) · [Web surfaces](https://docs.openpaw.ai/web)
...
Details: [Remote access](https://docs.openpaw.ai/gateway/remote) · [Nodes](https://docs.openpaw.ai/nodes) · [Security](https://docs.openpaw.ai/gateway/security)
...
Details: [Nodes](https://docs.openpaw.ai/nodes) · [macOS app](https://docs.openpaw.ai/platforms/macos) · [Gateway protocol](https://docs.openpaw.ai/concepts/architecture)
...
Details: [Session tools](https://docs.openpaw.ai/concepts/session-tool)
...
- Controlled via `openpaw nodes …`.

Runbook: [iOS connect](https://docs.openpaw.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.openpaw.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.openpaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.openpaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.openpaw/openpaw.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.openpaw.ai/gateway/configuration)
...
Details: [Security guide](https://docs.openpaw.ai/gateway/security) · [Docker + sandboxing](https://docs.openpaw.ai/install/docker) · [Sandbox config](https://docs.openpaw.ai/gateway/configuration)

### [WhatsApp](https://docs.openpaw.ai/channels/whatsapp)

- Link the device: `pnpm openpaw channels login` (stores creds in `~/.openpaw/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.openpaw.ai/channels/telegram)
...
### [Slack](https://docs.openpaw.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.openpaw.ai/channels/discord)
...
### [Signal](https://docs.openpaw.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.openpaw.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.openpaw.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.openpaw.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.openpaw.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.openpaw.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.openpaw.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.openpaw.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.openpaw.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.openpaw.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.openpaw.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.openpaw.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.openpaw.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.openpaw.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.openpaw.ai/platforms/windows), [Linux](https://docs.openpaw.ai/platforms/linux), [macOS](https://docs.openpaw.ai/platforms/macos), [iOS](https://docs.openpaw.ai/platforms/ios), [Android](https://docs.openpaw.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.openpaw.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.openpaw.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.openpaw.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.openpaw.ai/gateway/bonjour)
- [Gateway pairing](https://docs.openpaw.ai/gateway/pairing)
- [Remote gateway README](https://docs.openpaw.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.openpaw.ai/web/control-ui)
- [Dashboard](https://docs.openpaw.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.openpaw.ai/gateway/health)
- [Gateway lock](https://docs.openpaw.ai/gateway/gateway-lock)
- [Background process](https://docs.openpaw.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.openpaw.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.openpaw.ai/logging)

## Deep dives

- [Agent loop](https://docs.openpaw.ai/concepts/agent-loop)
- [Presence](https://docs.openpaw.ai/concepts/presence)
- [TypeBox schemas](https://docs.openpaw.ai/concepts/typebox)
- [RPC adapters](https://docs.openpaw.ai/reference/rpc)
- [Queue](https://docs.openpaw.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.openpaw.ai/tools/skills-config)
- [Default AGENTS](https://docs.openpaw.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.openpaw.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.openpaw.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.openpaw.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.openpaw.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.openpaw.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.openpaw.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.openpaw.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.openpaw.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.openpaw.ai/platforms/mac/voicewake)
- [iOS node](https://docs.openpaw.ai/platforms/ios)
- [Android node](https://docs.openpaw.ai/platforms/android)
- [Windows (WSL2)](https://docs.openpaw.ai/platforms/windows)
- [Linux app](https://docs.openpaw.ai/platforms/linux)
