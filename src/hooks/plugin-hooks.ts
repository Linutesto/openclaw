...
import type { OpenPawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenPawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenPawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
