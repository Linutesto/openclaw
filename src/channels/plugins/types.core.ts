...
export type ChannelAgentToolFactory = (params: { cfg?: OpenPawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenPawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenPawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenPawConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenPawConfig }) => boolean;
