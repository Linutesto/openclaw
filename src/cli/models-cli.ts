...
export function registerModelsCli(program: Command) {
  const models = program
    ...
    .option("--agent <id>", "Agent id to inspect (overrides OPENPAW_AGENT_DIR/PI_CODING_AGENT_DIR)")
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/models", "docs.openpaw.ai/cli/models")}\n`,
    );
