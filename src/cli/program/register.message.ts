...
${formatHelpExamples([
  ['openpaw message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'openpaw message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'openpaw message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.openpaw.ai/cli/message")}`,
    )
    .action(() => {
