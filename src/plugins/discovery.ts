...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @openpaw/voice-call -> voice-call).
...
export function discoverOpenPawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".openpaw", "extensions")];
