...
import type { GatewayBindMode, GatewayTailscaleMode, OpenPawConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.openpaw.ai/gateway/tailscale", "https://docs.openpaw.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
