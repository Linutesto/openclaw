...
function resolveMentionPatterns(cfg: OpenPawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenPawConfig | undefined, agentId?: string): RegExp[] {
