...
export function applyZaiConfig(cfg: OpenPawConfig): OpenPawConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpenPawConfig): OpenPawConfig {
...
export function applyOpenrouterConfig(cfg: OpenPawConfig): OpenPawConfig {
...
export function applyMoonshotProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: OpenPawConfig): OpenPawConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenPawConfig): OpenPawConfig {
...
export function applySyntheticProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenPawConfig): OpenPawConfig {
...
export function applyXiaomiProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenPawConfig): OpenPawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenPawConfig): OpenPawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenPawConfig): OpenPawConfig {
