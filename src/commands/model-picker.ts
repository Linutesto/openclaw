...
function resolveConfiguredModelRaw(cfg: OpenPawConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenPawConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenPawConfig, model: string): OpenPawConfig {
...
export function applyModelAllowlist(cfg: OpenPawConfig, models: string[]): OpenPawConfig {
  const defaults = cfg.agents?.defaults;
