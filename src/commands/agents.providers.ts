...
function resolveDefaultAccountId(cfg: OpenPawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenPawConfig): boolean {
...
export function summarizeBindings(cfg: OpenPawConfig, bindings: AgentBinding[]): string[] {
