...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.baseUrl": "Web Search SearX Base URL",
  "tools.web.search.maxResults": "Web Search Max Results",
  "tools.web.search.timeoutSeconds": "Web Search Timeout (sec)",
  "tools.web.search.cacheTtlMinutes": "Web Search Cache TTL (min)",
  "tools.web.search.rateLimitMs": "Web Search Rate Limit (ms)",
  "tools.web.search.defaultCrawlPages": "Web Search Default Crawl Pages",
  "tools.web.search.maxCrawlPages": "Web Search Max Crawl Pages",
  "tools.web.search.defaultExtractMode": "Web Search Default Extract Mode",
  "tools.web.search.defaultMaxContentChars": "Web Search Default Max Content",
  "tools.web.search.crawlTimeoutSeconds": "Web Search Crawl Timeout (sec)",
  "tools.web.searxng.enabled": "Enable SearXNG Search Tool",
  "tools.web.searxng.baseUrl": "SearXNG Base URL",
  "tools.web.searxng.timeoutSeconds": "SearXNG Timeout (sec)",
  "tools.web.searxng.cacheTtlMinutes": "SearXNG Cache TTL (min)",
  "tools.web.searxng.maxResults": "SearXNG Max Results",
  "tools.web.searxng.rateLimitMs": "SearXNG Rate Limit (ms)",
  "tools.web.discover.enabled": "Enable Web Discover Tool",
  "tools.web.discover.searxngBaseUrl": "Web Discover SearXNG Base URL",
  "tools.web.discover.timeoutSeconds": "Web Discover Search Timeout (sec)",
  "tools.web.discover.fetchTimeoutSeconds": "Web Discover Fetch Timeout (sec)",
  "tools.web.discover.cacheTtlMinutes": "Web Discover Cache TTL (min)",
  "tools.web.discover.maxResults": "Web Discover Max Results",
  "tools.web.discover.maxPages": "Web Discover Max Pages",
  "tools.web.discover.maxContentChars": "Web Discover Max Content",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.enabled": "Enable the web_search tool (local SearX-backed search).",
  "tools.web.search.baseUrl":
    "Local SearX/SearXNG base URL (fallback: SEARXNG_URL env var, then http://localhost:8080).",
  "tools.web.search.maxResults": "Default number of results to return (1-50).",
  "tools.web.search.timeoutSeconds": "Timeout in seconds for web_search requests.",
  "tools.web.search.cacheTtlMinutes": "Cache TTL in minutes for web_search results.",
  "tools.web.search.rateLimitMs": "Minimum delay between web_search requests in milliseconds.",
  "tools.web.search.defaultCrawlPages":
    "Default number of top results to crawl for content extraction (0 = search-only).",
  "tools.web.search.maxCrawlPages": "Hard cap for crawl depth in web_search calls (default: 10).",
  "tools.web.search.defaultExtractMode":
    'Default extraction mode for crawled pages ("markdown" or "text").',
  "tools.web.search.defaultMaxContentChars": "Default max characters extracted per crawled page.",
  "tools.web.search.crawlTimeoutSeconds": "Timeout in seconds for per-page crawl fetches.",
  "tools.web.searxng.enabled": "Enable the dedicated searxng_search tool.",
  "tools.web.searxng.baseUrl":
    "SearXNG base URL for searxng_search (fallback: SEARXNG_URL env var).",
  "tools.web.searxng.timeoutSeconds": "Timeout in seconds for searxng_search requests.",
  "tools.web.searxng.cacheTtlMinutes": "Cache TTL in minutes for searxng_search results.",
  "tools.web.searxng.maxResults": "Default max results for searxng_search.",
  "tools.web.searxng.rateLimitMs": "Minimum delay between searxng_search requests in milliseconds.",
  "tools.web.discover.enabled": "Enable the web_discover tool.",
  "tools.web.discover.searxngBaseUrl":
    "SearXNG base URL used by web_discover (fallback: SEARXNG_URL env var).",
  "tools.web.discover.timeoutSeconds": "Timeout in seconds for the search phase in web_discover.",
  "tools.web.discover.fetchTimeoutSeconds":
    "Timeout in seconds for page fetch/extraction in web_discover.",
  "tools.web.discover.cacheTtlMinutes": "Reserved for web_discover cache TTL settings.",
  "tools.web.discover.maxResults": "Default max search results returned by web_discover.",
  "tools.web.discover.maxPages": "Default max pages fetched/extracted by web_discover.",
  "tools.web.discover.maxContentChars":
    "Default max extracted characters per page in web_discover.",
