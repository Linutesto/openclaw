...
function isTelegramConfigured(cfg: OpenPawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OpenPawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OpenPawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OpenPawConfig): boolean {
...
function isIMessageConfigured(cfg: OpenPawConfig): boolean {
...
function isWhatsAppConfigured(cfg: OpenPawConfig): boolean {
...
function isGenericChannelConfigured(cfg: OpenPawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OpenPawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OpenPawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OpenPawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OpenPawConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: OpenPawConfig, pluginId: string): OpenPawConfig {
...
function enablePluginEntry(cfg: OpenPawConfig, pluginId: string): OpenPawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
