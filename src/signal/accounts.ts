...
export function listSignalAccountIds(cfg: OpenPawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OpenPawConfig): string {
...
function mergeSignalAccountConfig(cfg: OpenPawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenPawConfig): ResolvedSignalAccount[] {
