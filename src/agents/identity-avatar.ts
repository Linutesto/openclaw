...
function resolveAvatarSource(cfg: OpenPawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenPawConfig, agentId: string): AgentAvatarResolution {
