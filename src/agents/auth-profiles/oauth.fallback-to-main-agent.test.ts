...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenPawAgentDir() returns mainAgentDir
    process.env.OPENPAW_STATE_DIR = tmpDir;
    process.env.OPENPAW_AGENT_DIR = mainAgentDir;
