...
function resolveMainSessionKeyForSandbox(params: { cfg?: OpenPawConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: OpenPawConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`openpaw sandbox explain --session ${runtime.sessionKey}`)}`,
  );
