...
export function resolveConfigPath(config: OpenPawConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: OpenPawConfig | undefined, pathStr: string): boolean {
...
export function resolveSkillConfig(
  config: OpenPawConfig | undefined,
  skillKey: string,
...
const BUNDLED_SOURCES = new Set(["openpaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: OpenPawConfig): string[] | undefined {
