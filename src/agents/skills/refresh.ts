...
function resolveWatchPaths(workspaceDir: string, config?: OpenPawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenPawConfig }) {
