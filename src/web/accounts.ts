...
function listConfiguredAccountIds(cfg: OpenPawConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: OpenPawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenPawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenPawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenPawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenPawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenPawConfig): ResolvedWhatsAppAccount[] {
