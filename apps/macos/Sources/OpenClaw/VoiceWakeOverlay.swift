...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openpaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenPaw windows, but below the system’s pop-up menus.
