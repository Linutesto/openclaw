...
import "@a2ui/lit/ui";
import { themeContext } from "@openpaw/a2ui-theme-context";
...
class OpenClawA2UIHost extends LitElement {
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--openpaw-a2ui-inset-top, 0px)
        var(--openpaw-a2ui-inset-right, 0px)
        var(--openpaw-a2ui-inset-bottom, 0px)
        var(--openpaw-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--openpaw-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--openpaw-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--openpaw-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--openpaw-a2ui-empty-top, var(--openpaw-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    for (const eventName of ["openpaw:a2ui-action-status"]) {
...
if (!customElements.get("openpaw-a2ui-host")) {
  customElements.define("openpaw-a2ui-host", OpenClawA2UIHost);
}
